...
filled = cv2.morphologyEx(edges, cv2.MORPH_GRADIENT, cv2.getStructuringElement(cv2.MORPH_CROSS, (7,7)))
filled = cv2.erode(filled, cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (4,4)))
